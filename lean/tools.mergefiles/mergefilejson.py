...
old_file = os.path.join(BASE_PATH, 'Documents/resetthings6/RBCC/source/RBCC_Base/src/assets/api/langs/zh.json')
new_file = os.path.join(BASE_PATH, 'Downloads/Translated_IQ4-CirrusPro_strings/zh.json')
output_file = os.path.join(BASE_PATH, 'Documents/resetthings6/RBCC/source/RBCC_Base/src/assets/api/langs/zh.merged.json')
